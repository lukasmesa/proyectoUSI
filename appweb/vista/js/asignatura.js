...
$(function () {
    ...
    var columnas = [
        {'label': 'C&oacute;digo', name: 'cod_asignatura', index: 'cod_asignatura', width: 100, sortable: true, editable: true, editrules: {required: true, number: false, minValue: 1,custom:true,custom_func:check_function1},
