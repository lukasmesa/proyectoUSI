...
class prestamo_equipo {
    ...
    function add($param) {
        ...
        $sql = "INSERT INTO prestamo_equipo values('$codigo_prestamo','$fecha_inicio','$fecha_fin','$id_usuario','$equipo_prestamo')";
    ...
    function edit($param) {
        ...
        $sql = "UPDATE prestamo_equipo
					   ...
					   id_usuario='$id_usuario', equipo_prestamo='$equipo_prestamo'
    ...
    function select($param) {
        ...
        $sql = "SELECT codigo_prestamo,fecha_inicio,fecha_fin,id_usuario,equipo_prestamo from prestamo_equipo";
